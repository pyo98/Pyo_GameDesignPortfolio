...
const PROJECTS = [
  {
    ...
    platform: "PC",
    period: "2026",
    role: "게임기획, 레벨디자인, 캐릭터/배경 컨셉 정리, 문서화",
    fontClass: "project-theme-gucheon",
    color: "#b6323a",
    summary: "검은 이무기 묵의 반복된 순례와 구천의 저주를 다루는 한국형 다크판타지 로그라이트 프로젝트.",
    keywords: ["Roguelite", "Dark Korean Fantasy", "Level Design", "Pilgrimage", "Unreal Engine"],
    images: {
  ...
  },
  {
    ...
    platform: "PC",
    period: "2026",
    role: "게임기획, 스토리, 캐릭터/배경 컨셉, 스테이지 구조 설계",
    fontClass: "project-theme-the-flood",
    color: "#e3b634",
    summary: "운석우 이후 폐허가 된 서울에서 생존자들이 방어선을 구축하는 좀비 아포칼립스 타워디펜스 프로젝트.",
    keywords: ["Tower Defense", "Zombie Apocalypse", "Survival", "Stage Map", "Unreal Engine"],
    images: {
  ...
  },
  {
    ...
    platform: "PC",
    period: "2026",
    role: "게임기획, 세계관, 클래스 시스템, 메카닉스, 진영 구조 설계",
    fontClass: "project-theme-naiadel",
    color: "#31d0bd",
    summary: "뉴 상투스 인간 진영과 나이아델 엘프 왕국의 대립을 중심으로 하는 중세 하이판타지 MMORPG 프로젝트.",
    keywords: ["MMORPG", "Two Factions", "Class System", "World Tree", "RvR"],
    images: {
